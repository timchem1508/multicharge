...
*-list, -nlist, --nlist*::
Use neighbour list for solver (not compatible with charge gradient)

*-cut, -cutoff, --cutoff* _real_::
Cutoff for neighbour list generation in Bohrs (default: 29.0 Bohr)
