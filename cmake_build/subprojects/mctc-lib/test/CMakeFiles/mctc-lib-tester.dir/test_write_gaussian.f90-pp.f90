# 1 "/home/zakharov/Documents/prog/mcharge/multicharge/subprojects/mctc-lib/test/test_write_gaussian.f90"
# 1 "<built-in>"
# 1 "<command-line>"
...
subroutine collect_write_gaussian(testsuite)
...
end subroutine collect_write_gaussian
...
subroutine test_valid1_ein(error)
   ...
   call write_gaussian_external(struc, unit)
   rewind(unit)
...
end module test_write_gaussian
