# 1 "/home/zakharov/Documents/prog/mcharge/multicharge/src/multicharge/output.f90"
# 1 "<built-in>"
# 1 "<command-line>"
...
module multicharge_output
   ...
   use multicharge_solver_cg, only : mchrg_solver_cg
   use multicharge_solver_direct, only : mchrg_solver_direct
