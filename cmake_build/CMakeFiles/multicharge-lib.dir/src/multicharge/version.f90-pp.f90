# 1 "/home/zakharov/Documents/prog/mcharge/multicharge/src/multicharge/version.f90"
# 1 "<built-in>"
# 1 "<command-line>"
...
module multicharge_version
   ...
   character(len=*), parameter :: multicharge_version_string = "0.5.0"

   !> Numeric representation of the multicharge version
   integer, parameter :: multicharge_version_compact(3) = [0, 5, 0]
