# 1 "/home/zakharov/Documents/prog/mcharge/multicharge/src/multicharge/model/type.F90"
# 1 "<built-in>"
# 1 "<command-line>"
...
module multicharge_model_type
   ...
   use mctc_env, only: timer_type, format_time, error_type, fatal_error, wp,  ik => i4
